...
As presented in Equation \ref{eq:weather_eq} \hl{adapted from} \cite{Rogers1989}, the weather radar equation is defined by constant parameters dependent on the radar system characteristics, and
