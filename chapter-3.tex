...
It is still possible to extract a signal from the noise and calibration issues, by using the median KDE as a threshold. Points below the median KDE are discarded, then the constrained set is used to resolve the bias present in
...
\end{figure}
The scatter-plot in Figure \ref{fig:scatter_ref_20140123} shows an analysis
